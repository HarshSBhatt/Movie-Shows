...
function Navbar() {
  ...
  const listOfCategory = Object.entries(requests)?.map(
    ([key, { title, url }]) => {
      ...
      return (
        <h2
          ...
          className={`last:pr-32 cursor-pointer transition duration-100 transform hover:scale-125 hover:text-white active:text-gray-500 ${
